      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <select name="input-month" id="input-month" onChange={updateEventMonth}>
            ...
            <input type="text" id='event-name' placeholder='Title' onChange={updateEventName}/>
            <br></br>
            <input type="text" id='event-description' placeholder='Description' size="50" onChange={updateEventDescription}/>
            <br></br>
            <label>start:
              <input type="text" pattern="\d*" min="1" max="12" name="start-time-hour" placeholder='00' maxLength="2" size="2" onChange={updateStartHour}/>
          ...
          <button className="submit-button" onClick={onSubmit}>Add</button>
          </div>
          </form>
        </div>
      </div>
